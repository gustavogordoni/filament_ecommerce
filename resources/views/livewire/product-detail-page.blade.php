                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                ...
                                <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">R$
                                    1800.99</span>
                            </p>
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click='addToCart({{ $product->id }})'
                                ...
                                <span wire:loading.remove class="font-semibold">Add to cart</span>
                                <span wire:loading class="font-semibold">Adding...</span>
                            </button>
                        </div>
                    </div>
                </div>
