<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="flex items-center font-poppins">
        <div
            ...
            <div>
                <h1 class="px-4 mb-8 text-2xl font-semibold tracking-wide text-gray-700 dark:text-gray-200">
                    ...
                    <div class="flex items-start justify-start flex-shrink-0">
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <div class="flex flex-col items-start justify-start space-y-2">
                                <p class="text-lg font-semibold leading-4 text-left text-gray-800 dark:text-gray-200">
                                    {{ $order->address->first_name . ' ' . $order->address->first_name }}</p>
                                <p class="text-sm leading-4 text-gray-600 dark:text-gray-300">
                                    {{ $order->address->street_address }}</p>
                                <p class="text-sm leading-4 text-gray-600 dark:text-gray-300">
                                    {{ $order->address->city . ', ' . $order->address->state . ', ' . $order->address->zip_code }}
                                </p>
                                <p class="text-sm leading-4 cursor-pointer dark:text-gray-300">Phone:
                ...
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-200">
                            Order Number: </p>
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm font-medium leading-5 text-gray-800 dark:text-gray-200">
                            Total: </p>
                        <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-300">
                            {{ Number::currency($order->grand_total, 'BRL') }}</p>
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-200">
                            Payment Method: </p>
                ...
                <div class="px-4 mb-10">
                    <div
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-200">Order details</h2>
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-300">
                                        {{ Number::currency($order->grand_total, 'BRL') }}</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <p class="text-base font-semibold leading-4 text-gray-600 dark:text-gray-300">
                                    {{ Number::currency($order->grand_total, 'BRL') }}
                                </p>
                            </div>
                        </div>
                        <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                            <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-200">Shipping</h2>
                ...
                <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                    ...
                    <a href="/my-orders"
                        class="w-full text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto dark:text-gray-300hover:bg-blue-600 dark:hover:bg-gray-700 dark:bg-gray-800">
                        View My Orders
                    </a>
                </div>
            </div>
