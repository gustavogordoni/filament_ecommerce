                            ...
                            @foreach ($categories as $categorie)
                                <li class="mb-4" wire:key="{{ $categorie->id }}">
                                    <label for="{{ $categorie->slug }}" class="flex items-center dark:text-gray-400 ">
                                        <input id="{{ $categorie->slug }}" type="checkbox" wire:model.live="selected_categories" value="{{ $categorie->id }}" class="w-4 h-4 mr-2">
                                        <span class="text-lg">{{ $categorie->name }}</span>
                                    </label>
                                </li>
                            @endforeach
                        </ul>
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between ">
                                ...
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(30000, 'BRL') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span
                                                class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'BRL') }}</span>
                                        </p>
                                    </div>
