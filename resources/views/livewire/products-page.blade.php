                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900 rounded-lg">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between ">
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(10, 'BRL') }}</span>
                                <span
                                    class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(30000, 'BRL') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
